...
class SettingsService {
  ...
  static const _keyTrainingConsent = 'training_consent';
  ...
  /// Liest die Einwilligung zum KI-Training. Standard: false
  static Future<bool> getTrainingConsent() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getBool(_keyTrainingConsent) ?? false;
  }

  /// Speichert die Einwilligung zum KI-Training
  static Future<void> setTrainingConsent(bool value) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(_keyTrainingConsent, value);
  }
}
