...
DENKPROZESS (Chain-of-Thought — PFLICHT vor JSON-Ausgabe):
Bevor du JSON ausgibst, durchlaufe intern diese 5 Schritte und fasse jeden in 1 Satz im Feld "begruendung" zusammen:
